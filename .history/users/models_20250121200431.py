...
class Usuario(AbstractUser):
    ...
    dataNascimento = models.DateField(null=False, blank=True)
    Bairro = models.TextField(max_length=255, blank=True, null=False, default='Endereço não informado')
    Rua = models.TextField(max_length=255, blank=True, null=False, default='Endereço não informado')
    complemento = models.TextField(max_length=255, blank=True, null=False, default='Endereço não informado')

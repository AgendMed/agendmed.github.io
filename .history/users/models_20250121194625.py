...
class Usuario(AbstractUser):
    ...
    telefone = models.CharField(max_length=15, blank=True, null=False, default='Telefone não informado')
    endereco = models.TextFieldField(max_length=255, blank=True, null=False, default='Endereço não informado')

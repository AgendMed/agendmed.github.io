...
class Usuario(AbstractUser):
    ...
    telefone = models.CharField(max_length=100, blank=True, null=False, default='Telefone não informado')
    endereco = models.TextField(max_length=255, blank=True, null=False, default='Endereço não informado')

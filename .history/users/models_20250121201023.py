...
class Usuario(AbstractUser):
    ...
    dataNascimento = models.DateField(null=False, blank=True, default='data de Nascimento não informado')
    ...
    NumeroCasa = models.CharField(max_length=255null=False, default='Numero da Casa não informado')

...
class Usuario(AbstractUser):
    ...
    telefone = models.CharField(max_length=15, blank=True, null=False, default='Endereço não informado')
    endereco = models.CharField(max_length=255, blank=True, null=False, default='Endereço não informado')

...
class CadastroPacienteForm(forms.ModelForm):
    ...
    dataNascimento = forms.DateField(null=False, blank=True, default=date(2000, 1, 1))
    Bairro = forms.TextField(max_length=255, blank=True, null=False, default='Bairro não informado')
    Rua = forms.TextField(max_length=255, blank=True, null=False, default='Rua não informada')
    complemento = forms.TextField(max_length=255, blank=True, null=False, default='complemento não informado')
    NumeroCasa = models.CharField(max_length=30, null=False, default='Numero da Casa não informado')

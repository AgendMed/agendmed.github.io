...
from .views import cadastrar_campanha, listar_campanhas, deletar_campanha, visualizar_campanhas
...
urlpatterns = [
    ...
    path('campanhas/', visualizar_campanhas, name='visualizar_campanhas'),
]
